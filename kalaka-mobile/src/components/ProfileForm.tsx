...
export default class AppHeader extends Component<Props> {
    constructor(props){
        ...
        this.state = {
            availableValue: true,
            visibleOnMapValue: true,
        }
    }
  render() {
    return (
      <View style={{height: 350, marginTop: 20}}>
            <AntDesign name="closecircleo" color="grey" size={25} style={{position: "absolute", right: 18}} onPress={()=>{this.props.setModalVisible()}}/>
            <Grid style={{marginTop: 20}}>
                <Row>
                    <Col alignItems="center" justifyContent="center" style={{marginTop: 45}}>
                    ...
                    <Col style={{height: 150, marginTop: 20}} alignItems="center" justifyContent="center">
                        <Row  justifyContent="center">
                            ...
                            <Col size={1}  justifyContent="center" style={{marginRight: 16}}>
                ...
                <Row style={{marginBottom: -70}}>
                    <Text style={{ fontSize: 10, marginLeft: 50, marginTop: 20 }}>
